...
export const create = mutation({
  args: {
    ...
    isNativePaymentProtected: v.boolean(),
...
async function productResponse(ctx: any, row: any) {
  ...
  return {
    ...
    providerWallet:
      user?.walletAddress ?? '5GrwvaEF5zXb26Fz9rcQpDWSqDg3pxHLfXdyBR1UxqVxF8p',
    ...
    pricing: { model: 'fixed' },
    method: row.method,
    endpointPath: `/api/credits/products/${row.slug}/call`,
    ...
    responseSchema,
    referencePayload,
    isNativePaymentProtected: row.isNativePaymentProtected,
