    ...
    <div className='space-y-8'>
      <section className='bg-panel-sheen border-foreground/10 rounded-lg border p-6'>
        ...
        <div className='mt-4 max-w-3xl space-y-3'>
          ...
          <p className='text-foreground/70 text-sm leading-6'>
            Audit every recorded POT receipt, provider share, platform fee,
      ...
      <section className='grid gap-4 md:grid-cols-2 xl:grid-cols-4'>
        {[
          ...
          {
            label: 'Gross volume',
            value: `${gross.toFixed(2)} POT`,
            detail: 'Total paid amount',
            icon: CircleDollarSign
          },
          {
            label: 'Provider share',
            value: `${providerShare.toFixed(2)} POT`,
            detail: 'Released to providers',
            icon: Split
          },
          {
            label: 'Platform fees',
            value: `${platformFees.toFixed(2)} POT`,
      ...
      <ServerDataTable
        ...
        emptyDescription='Receipts appear after paid Portaldot payment, managed-credit, or agent actions settle.'
