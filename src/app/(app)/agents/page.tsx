        ...
        <div className='grid gap-6 xl:grid-cols-[1fr_520px] xl:items-center'>
          <div className='max-w-3xl space-y-5'>
            ...
            <div className='space-y-3'>
              ...
              <p className='text-foreground/70 max-w-2xl text-sm leading-6'>
                ...
                spends through Portaldot payment, records receipts, and
                publishes an on-chain proof.
              </p>
            </div>
          ...
          <div className='grid gap-3 sm:grid-cols-2'>
            ...
            <MetricTile
              ...
              label='Spend'
              value={`${metrics.totalSpendUsdc} POT`}
            />
          </div>
        </div>
      </section>
    ...
    render: template => (
      <div>
        <p className='font-semibold'>
          {template.recommendedBudgetUsdc.toFixed(2)} POT
        </p>
