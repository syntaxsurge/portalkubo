      ...
      <Card className='space-y-4'>
        ...
        <div className='grid gap-3 md:grid-cols-4'>
          {[
            ...
            ['Spend', `${agentMetrics.totalSpendUsdc} POT`]
          ].map(([label, value]) => (
          ...
          <div className='border-foreground/10 bg-muted/40 rounded-lg border p-4 text-sm'>
            <div className='flex gap-3'>
              ...
              <p className='text-foreground/70 leading-6'>
                Portaldot payment remains available for every listed API.
                Managed credits are an optional API-key workflow.
              </p>
            </div>
          </div>
        </div>
...
function apiKeyColumns(): ServerDataTableColumn<BillingApiKeyRow>[] {
  return [
    ...
    },
    {
      ...
      label: 'Balance',
      sortKey: 'balance',
      render: row => <p className='font-semibold'>{row.balanceUsdc} POT</p>
    },
    {
      key: 'activity',
      label: 'Activity',
