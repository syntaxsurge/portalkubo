        ...
        <div className='mt-4 grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-end'>
          <div className='space-y-3'>
            ...
            <p className='text-foreground/70 max-w-2xl text-sm leading-6'>
              Create a payable request record for this API. No POT is charged on
              this page; the paid response is returned after a Portaldot payment
              buyer client, backend, CLI, or agent signs and settles the
              payment.
            </p>
          </div>
          <Card className='bg-background/85'>
            ...
            <p className='text-foreground/65 mt-2 text-sm leading-6'>
              Charged only after signed Portaldot payment settlement on the
              configured network.
            </p>
          </Card>
        </div>
