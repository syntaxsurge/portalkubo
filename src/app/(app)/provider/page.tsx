    ...
    <div className='space-y-8'>
        ...
        <div className='grid gap-6 lg:grid-cols-[1fr_320px] lg:items-end'>
          ...
          <Card className='bg-background/85'>
            ...
            <p className='text-foreground/65 mt-2 text-sm leading-6'>
              {topProduct
                ? `${topProduct.revenueUsdc} POT recorded across ${topProduct.calls} calls.`
        ...
        {[
          {
            ...
            value: `${providerMetrics.providerRevenueUsdc} POT`,
          ...
          },
          {
            ...
            detail: `${agentMetrics.totalSpendUsdc} POT agent spend`,
            icon: Receipt
          },
          {
            label: 'Success rate',
      ...
      <section className='grid gap-5 xl:grid-cols-[1.15fr_0.85fr]'>
            ...
            {products.map(product => (
              ...
              >
                ...
                <div>
                  ...
                  <p className='font-semibold'>{product.revenueUsdc} POT</p>
                </div>
                <div>
                  <p className='text-foreground/60 text-xs uppercase'>
                    Success
        ...
        <Card className='space-y-5'>
          ...
          <div className='grid gap-3'>
            {[
              ['Gross volume', `${providerMetrics.grossVolumeUsdc} POT`],
              ['Provider earned', `${providerMetrics.providerRevenueUsdc} POT`],
              ['Platform fees', `${providerMetrics.platformFeeUsdc} POT`],
          ...
          <div className='grid gap-3'>
            {orders.length > 0 ? (
              ...
              <div className='bg-muted rounded-lg p-4'>
                ...
                <p className='text-foreground/65 mt-2 text-sm leading-6'>
                  Settled Portaldot payment orders will appear here after buyers
                  or agents call provider listings.
                </p>
              </div>
            )}
          </div>
