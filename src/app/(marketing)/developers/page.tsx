...
export default function DevelopersPage() {
  const steps = [
    ...
    },
    {
      ...
      detail: 'Return HTTP 402 until the POT payment is valid.'
    },
    {
      title: 'Use Portaldot payment directly',
      detail: 'Call the hosted endpoint with a Portaldot payment buyer client.'
    },
    {
      title: 'Use credits',
      ...
      <section className='mx-auto grid w-full max-w-6xl gap-10 px-6 py-16 lg:grid-cols-[1fr_0.8fr] lg:items-center'>
        <div className='space-y-6'>
          ...
          <p className='text-foreground/70 max-w-2xl text-sm leading-6'>
            Add a listing, protect it with Portaldot payment, forward requests,
            and keep receipts on Portaldot.
          </p>
