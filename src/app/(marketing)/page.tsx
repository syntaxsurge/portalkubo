...
const agentFlow = [
  ...
  { icon: WalletCards, title: 'Pay', detail: 'Budgeted POT' },
      ...
      <section className='container-page relative isolate py-16 sm:py-20 lg:py-24'>
        ...
        <div className='max-w-4xl space-y-7'>
          ...
          <div className='space-y-5'>
            ...
            <p className='text-lead max-w-2xl'>
              ...
              with Portaldot payment, and OpenAI agents spend from funded
              budgets with receipts.
            </p>
          </div>
        ...
        <div className='mt-10 grid gap-3 sm:grid-cols-3'>
          {[
            ...
            { label: 'Settlement rail', value: 'POT' }
          ].map(item => (
            <div
              key={item.label}
