          ...
          >
            <div className='grid gap-4 lg:grid-cols-[1fr_320px]'>
              <div className='border-border bg-primary/5 rounded-lg border p-4 text-sm leading-6'>
                ...
                POT deposit into the agent budget vault before any paid action
    ...
    <div className='border-border overflow-hidden rounded-lg border'>
      <div className='border-border bg-background/50 border-b p-4'>
        ...
        {selectedTools.length === 0 ? (
          <p className='border-warning/40 bg-warning/15 text-warning-foreground dark:text-warning mt-3 rounded-lg border p-3 text-sm'>
