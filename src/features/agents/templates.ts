...
export const agentTemplates: AgentTemplate[] = [
  {
    ...
    objective: 'Create a launch pack for my POT-native paid API product.',
    sourceText:
      'The product sells premium API responses to AI agents and records POT receipts on-chain.',
