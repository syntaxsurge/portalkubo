      ...
      <Card className='space-y-5'>
        <div className='flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between'>
          <div>
            <SectionHeader
              eyebrow='Pricing'
              title='Fixed or usage-based POT'
            ...
            <p className='text-foreground/65 mt-2 max-w-3xl text-sm leading-6'>
              ...
              usage value that the gateway converts into POT before Portaldot
              payment payment.
            </p>
          </div>
        ...
        <div className='grid gap-4 md:grid-cols-2'>
          <SelectField
            ...
            help='Fixed charges one POT amount per call. Credit-metered reads a credit value and converts it into POT.'
          >
          ...
          <Field
            label={isCreditMetered ? 'Fallback price in POT' : 'Price in POT'}
            name='priceUsd'
            type='number'
            step='0.000001'
            defaultValue=''
          ...
          <Field
            ...
            help='Optional provider quote endpoint the gateway calls before Portaldot payment to calculate usage-based price from the request payload.'
          />
          <SelectField
            label='Quote method'
          ...
          <Field
            ...
            help='Conversion rate used to turn provider credits into POT. Example: 0.01 means 100 credits equals 1 POT.'
          />
          <Field
            ...
            help='Optional markup or discount multiplier applied after converting credits into POT.'
          />
          <Field
            label='Minimum charge POT'
