...
export const orderStatusDetails: Record<OrderStatus, string> = {
  ...
  payment_required:
    'The payable request is ready. Run it with the connected wallet or execute the same endpoint from a Portaldot payment buyer client, backend, CLI, or autonomous agent.',
  quoted:
  ...
  delta_payment_required:
    'The final metered cost is higher than the prepaid quote. Pay the remaining POT before the result is revealed.',
